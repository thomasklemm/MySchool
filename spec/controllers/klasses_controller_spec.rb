  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved klass as @klass" do
        ...
        post :create, {:klass => { "school" => "invalid value" }}, valid_session
        assigns(:klass).should be_a_new(Klass)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested klass" do
        ...
        Klass.any_instance.should_receive(:update).with({ "school" => "" })
        put :update, {:id => klass.to_param, :klass => { "school" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the klass as @klass" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Klass.any_instance.stub(:save).and_return(false)
        put :update, {:id => klass.to_param, :klass => { "school" => "invalid value" }}, valid_session
        assigns(:klass).should eq(klass)
      end
